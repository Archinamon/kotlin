...
interface IrBuilderExtension {
    ...
    fun IrProperty.getEncodeDefaultAnnotationValue(): Boolean? {
        val call = annotations.find { it.symbol.owner.constructedClass.fqNameWhenAvailable == SerializationAnnotations.encodeDefaultFqName } ?: return null
        val arg = call.getValueArgument(0) ?: return true // ALWAYS by default
        val argValue = (arg as? IrGetEnumValue ?: return null).symbol.owner.name.toString() // not a enum arg???
